  ...
  stages {
    ...
    stage('Push image') {
      steps {
        ...
        withDockerRegistry(credentialsId: 'sri556', url: 'https://118463809662.dkr.ecr.ap-south-1.amazonaws.com/sri556') {
          sh '/usr/bin/docker tag 118463809662.dkr.ecr.ap-south-1.amazonaws.com/sri556:latest'
